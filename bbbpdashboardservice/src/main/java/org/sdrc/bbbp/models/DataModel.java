...
public class DataModel {
	...
	public String toString() {
		return "UtDataModel [id=" + id + ", areaCode=" + areaCode + ", areaName=" + areaName + ", value=" + value + ", unit=" + unit + ", rank=" + rank + ", cssClass=" + cssClass + ", percentageChange=" + percentageChange + ", isPositiveTrend=" + isPositiveTrend + ", dataSeries=" + dataSeries + ", lineSeries=" + lineSeries + ", columnSeries=" + columnSeries + ", isColumnVisible=" + isColumnVisible
				+ "]";
	}
